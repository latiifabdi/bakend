        ...
        <div class="container mx-auto">
          <div class="lg:flex lg:pt-16">
            <div class="lg:mt-16 lg:w-1/2 md:mr-16">
              <h1 class="lg:mb-4 md:mb-1 sm:mb-1  px-8 md:px-0 lg:text-5xl text-2xl text-white">
            ...
            <div class="lg:w-1/2  sm:ml-8 md:ml-0 lg:ml-16">
              <div id="quote" class="max-w-sm bg-red py-8 text-white rounded-lg shadow-lg">
                <div class="px-8 mt-2">
                  <h4 class="text-center mb-2 lg:mb-4">Get Quote Now</h4>
                  ...
                  <form class="text-center" action="https://formspree.io/faithtandi@hotmail.com" method="POST">
                    <div class="mb-6">
                      <input type="text" class="lg:py-5 py-3 w-3/4 px-8 lg:px-12 rounded-full border border-white text-grey-light hover:border-white bg-red" name="name" placeholder="Your name?">
                      <input type="hidden" name="_subject" value="Request quote to Nelsoft private limited!" />
                    </div>
                    <div class="mb-6">
                      <input autocomplete="off" type="text" class="lg:py-5 py-3 px-8 w-3/4 lg:px-12 rounded-full border border-white text-grey-light hover:border-white bg-red"  name="_replyto" placeholder="Your Email address?">
                    </div>
                    <div class="mb-6">
                      <textarea  cols="30" class="lg:py-5 py-3 w-3/4 px-8 lg:px-12 rounded-full border border-white text-grey-light hover:border-white bg-red" name="message" placeholder="Your Message!!"></textarea>
                    </div>
                    <button class="text-white rounded-lg w-3/5 py-3 px-3 lg:px-4 lg:py-4" style="background: rgb(1, 118, 255);">
                    Submit
                    </button>
                  </form>
                </div>
